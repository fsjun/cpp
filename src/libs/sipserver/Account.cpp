...
void Account::update_keep_alive(pj_bool_t start, struct pjsip_regc_cbparam* param)
{
    ...
    if (start) {
        ...
        INFOLN("Keep-alive timer started for acc {}, destination:{}, interval:{}s\n", mUri, addr, mKaInterval);
    }
}
