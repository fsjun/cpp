...
#define WARNLNLN(format, ...) SPDLOG_LOGGER_WARNLN(spdlog::get("log"), format EOL, ##__VA_ARGS__)
#define INFOLNLN(format, ...) SPDLOG_LOGGER_INFOLN(spdlog::get("log"), format EOL, ##__VA_ARGS__)
#define DEBUGLNLN(format, ...) SPDLOG_LOGGER_DEBUGLN(spdlog::get("log"), format EOL, ##__VA_ARGS__)
